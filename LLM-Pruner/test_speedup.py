...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_model', type=str, default="lmsys/vicuna-7b-v1.5", help='base model name')
    parser.add_argument('--model_type', type=str, default="pruneLLM", help = 'choose from [pretrain, pruneLLM]')
    parser.add_argument('--ckpt', type=str, default='/shared-local/aoq609/VLMCompression/LLM-Pruner/LLMPruner/prune_log/llava-v1.5-7b_0.4/pytorch_model.bin')
