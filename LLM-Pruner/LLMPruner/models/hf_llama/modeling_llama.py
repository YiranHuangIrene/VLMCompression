...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        try:
            ...
            print("query state:",self.q_proj, query_states.size(), "hidden states:", hidden_states.size())
        try:
            ...
            print("key state:",self.k_proj, key_states.size(), "hidden states:", hidden_states.size())
        try:
            ...
            print("value state:",self.v_proj, value_states.size(), "hidden states:", hidden_states.size())
